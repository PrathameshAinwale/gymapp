              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <span
                      className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-md text-[10px] font-bold shrink-0 ${isActive
                  ...
                  {filteredFreezes.map((f) => {
                    ...
                    return (
                      <tr key={f.id} className="hover:bg-slate-50/70 transition-colors">
                        ...
                        <td className="py-3.5 px-5">
                          <span
                            className={`inline-flex items-center gap-1 px-2.5 py-0.5 rounded-full text-[10px] font-bold ${isActive
                                ? 'bg-amber-50 text-amber-700 border border-amber-200'
                                : 'bg-emerald-50 text-emerald-700 border border-emerald-200'
                              }`}
                          >
